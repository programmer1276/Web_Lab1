        ...
        while (fcgiInterface.FCGIaccept() >= 0) {
            ...
            if (method.equals("GET")) {
                ...
                if (queryString!=null) {
                    ...
                    boolean isValid;
                    try{
                        isValid = validation.isValid(Integer.parseInt(values.get("x")), Float.parseFloat(values.get("y")), Float.parseFloat(values.get("r")));
                        isHit = check.checkHit(Integer.parseInt(values.get("x")), Float.parseFloat(values.get("y")), Float.parseFloat(values.get("r")));
                    } catch (Exception e){
